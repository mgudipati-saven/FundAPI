=begin
  Redis DB layout for fund historical data is defined as follows:
...
# call using "ruby load-mf-hist.rb -i<input file>"  
unless ARGV.length == 1
  puts "Usage: ruby oad-mf-hist.rb -i<input file>" 
  exit  
end  
...
=begin rdoc
 * Name: load-mf-hist.rb
 * Description: Loads fund historical data file into redis db.
 * Call using "ruby load-mf-hist.rb -i, --infile=<fund hist file>"  
